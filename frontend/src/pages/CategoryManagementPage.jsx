...
function CategoryManagementPage() {
  ...
  const loadCategories = useCallback(async () => {
    try {
      ...
      setError('There was a problem loading categories.');
      console.error(err);
    }
  }, []);
  ...
  const handleCreateCategory = async (event) => {
    ...
    try {
      ...
      setError('There was a problem creating the category.');
      console.error(err);
    }
  };
  ...
  const handleUpdateCategory = async (event) => {
    ...
    try {
      ...
      setError('There was a problem updating the category.');
      console.error(err);
    }
  };
  ...
  const handleDeleteCategory = async (categoryId) => {
    ...
    try {
      ...
      setError('There was a problem deleting the category. Make sure no links are attached.');
      console.error(err);
    }
  };
  ...
  return (
    <div className="app category-management">
      <header className="app__header category-management__header">
        ...
        <p>Add categories, update their names and colors, or remove them.</p>
      ...
      <main>
        ...
        <section className="category-panel category-management__panel">
          <h2>Custom Category Management</h2>
          ...
          <ul className="category-list">
            ...
            {categories.length === 0 && (
              <li className="category-list__empty">Add a category to get started.</li>
            )}
          </ul>
        </section>
      </main>
